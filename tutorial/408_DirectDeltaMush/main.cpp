...
int main(int argc, char *argv[])
{
  ...
  Eigen::MatrixXi F, BE;
  igl::read_triangle_mesh("../../data/elephant.obj", V, F);
  igl::readTGF("../../data/elephant.tgf", C, BE);
  igl::readDMAT("../../data/elephant-weights.dmat", W);
  igl::readDMAT("../../data/elephant-anim.dmat", T);
